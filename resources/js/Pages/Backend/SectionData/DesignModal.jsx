...
const DesignModal = () => {
    const{visibleDesign, setVisibleDesign, setVisibleCreateDesignModal, fieldData, setData} = useContext(SectionDataContext)
    const handleClick = (id) => {
        ...
        setVisibleDesign(false)
        setVisibleCreateDesignModal(true)
    }
  return (
    <Rodal visible={visibleDesign} width={800} height={400} onClose={() => setVisibleDesign(false)}>
